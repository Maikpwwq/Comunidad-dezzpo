# Acuerdo de Usuario — Propietarios
...
**10.4. Sus derechos.** Usted puede conocer, actualizar, rectificar y solicitar la supresión de sus datos personales, solicitar prueba de la autorización otorgada, ser informado sobre su uso, y presentar quejas ante la Superintendencia de Industria y Comercio, escribiendo a [correo de contacto de datos personales].

**10.5. Registro de bases de datos.** Dezzpo mantiene sus bases de datos conforme a la Ley 1581 de 2012 independientemente de su tamaño. La inscripción formal ante el Registro Nacional de Bases de Datos (RNBD) aplica a partir de que la sociedad supere el umbral de activos definido por la Superintendencia de Industria y Comercio; monitorearemos esta obligación conforme crezca la operación.
