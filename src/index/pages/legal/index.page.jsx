            ...
            <Container fluid className="p-0">
                <Row className="legalContainer">
                    <Col className="m-4">
                        ...
                        >
                            <h3 className="headline-l textBlanco">
                                ...
                                <br /> Propietarios <DownloadIcon fontSize='large'/>
                            </h3>
                        </a>
                    </Col>
                    <Col className="m-4">
                        ...
                        >
                            <h3 className="headline-l textBlanco">
                                Terminos y condiciones de uso 
                                <br /> Comercientes Calificados <DownloadIcon fontSize='large'/>
                            </h3>
                        </a>
                    </Col>
                    ...
                    <Col className="m-4">
                        ...
                        >
                            <h3 className="headline-l textBlanco">
                                Politica de privacidad  <DownloadIcon fontSize='large'/>
                            </h3>
                        </a>
                    </Col>
                    <Col className="m-4">
                        <a
                            ...
                            rel="noopener noreferrer"
                        >
                            <h3 className="headline-l textBlanco">Cookies  <DownloadIcon fontSize='large'/> </h3> 
                        </a>
                    </Col>
                </Row>
            </Container>
