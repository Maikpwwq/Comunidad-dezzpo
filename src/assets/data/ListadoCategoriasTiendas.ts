...
export const ListadoCategoriasTiendas: TiendaCategoryOption[] = [
    ...
    },
    {
        ...
        parentTradeKey: 53,
        iconName: 'Fence',
        description: 'Rejas, pasamanos, puertas metálicas decorativas, balcones y cerramientos ornamentales.',
        synonyms: ['ornamentación', 'ornamentacion', 'rejas', 'pasamanos', 'balcones', 'cerramientos', 'forja', 'herrería artística', 'barandas'],
    },
    {
        key: 'perfiles_hierro',
        ...
        parentTradeKey: 53,
        iconName: 'SquareFoot',
        description: 'Perfiles de hierro, tubos estructurales, platinas, ángulos, varillas y láminas.',
        synonyms: ['hierro', 'perfiles de hierro', 'ángulos', 'platinas', 'tubos estructurales', 'varillas', 'láminas', 'vigas', 'canales de hierro'],
    },
    {
    ...
    {
        key: 'muebles_closets',
        label: 'Muebles y Closets',
        parentTradeKey: 17,
        iconName: 'Chair',
        description: 'Muebles de oficina, salas, comedores, closets, armarios y muebles modulares.',
        synonyms: ['muebles', 'mueblería', 'muebleria', 'sillas', 'escritorios', 'closets', 'armarios', 'muebles modulares', 'comedores', 'salas', 'estanterías'],
    },
    {
        key: 'tapiceria',
        label: 'Tapicería',
        parentTradeKey: 17,
        iconName: 'Weekend',
        description: 'Tapizado de muebles, telas para tapicería, espumas, cuerina y restauración de sillas.',
        synonyms: ['tapicería', 'tapiceria', 'tapizado', 'telas de tapicería', 'espumas', 'cuerina', 'restauración de muebles', 'retapizado'],
    },
    {
    ...
    },
    {
        ...
        parentTradeKey: 53,
        iconName: 'Diamond',
        description: 'Acero inoxidable en láminas, tubos, perfiles, accesorios y barandas de acero inox.',
        synonyms: ['inoxidable', 'inox', 'acero inoxidable', 'láminas inoxidables', 'tubos inoxidables', 'barandas inoxidables', 'pasamanos inox'],
    },
    {
        key: 'mallas_metalicas',
        label: 'Mallas Metálicas',
        parentTradeKey: 53,
        iconName: 'GridView',
        description: 'Mallas eslabonadas, electrosoldadas, concertinas, gaviones y mallas para cerramiento.',
        synonyms: ['mallas', 'malla eslabonada', 'malla electrosoldada', 'concertina', 'gavión', 'gaviones', 'cerramiento', 'malla metálica', 'alambre'],
    },
    {
        key: 'puertas',
        label: 'Puertas',
        parentTradeKey: 17,
        iconName: 'DoorFront',
        description: 'Puertas en madera, metálicas, de seguridad, cortafuego, corredizas y accesorios.',
        synonyms: ['puertas', 'puerta', 'puerta de seguridad', 'puerta metálica', 'puerta corrediza', 'puerta cortafuego', 'marcos de puerta', 'chapa de puerta'],
    },
    {
        key: 'transmision_potencia',
        label: 'Transmisión de Potencia',
        parentTradeKey: 52,
        iconName: 'Settings',
        description: 'Rodamientos, poleas, correas, cadenas, sprockets, reductores y acoples industriales.',
        synonyms: ['transmisión de potencia', 'rodamientos', 'poleas', 'correas', 'cadenas', 'sprockets', 'reductores', 'acoples', 'chumaceras', 'piñones'],
    },
    {
        key: 'depositos_materiales',
        label: 'Depósitos de Materiales',
        parentTradeKey: 50,
        iconName: 'Warehouse',
