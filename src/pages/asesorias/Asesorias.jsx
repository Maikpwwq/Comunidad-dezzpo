                    ...
                    <div className="asesoriasTitulo">
                        <span className="opacidadNegro">
                            ...
                            <p className="asesoriaMessage">
                                ...
                                resulve ya las
                                <br />
                                dudas que tengas en cuanto a tecnicas,
                                especificaciones de
                                <br />
                                materiales, alcance, tiempo y costo, de tu nuevo
                                proyecto.
                            </p>
                        </span>
                    </div>
                    ...
                    <div className="asesoriasBlog">
                        <div className="row">
                            <div className="col3">
                                ...
                                <p>
                                    Revisa las ultimas preguntas y respuestas de
                                    la comunidad, y
                                    <br />
                                    participa.
                                </p>
