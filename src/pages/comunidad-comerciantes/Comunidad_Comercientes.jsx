                ...
                <div className="container">
                    <div className="comunidadComerciantesTitulo">
                        <div className="opacidadNegro">
                            <span className="pitchComerciantes"> <h2>¿TE FALTA GESTIÓN?, DÉJANOS REPRESENTAR <br/>
                            ...
                            <span className="blueAlert"> Solicita Tu Membresia Ahora </span>
                        </div>                
                    </div>
                            ...
                            <div className="colLeft">
                                <div className="registrateformulario">
                                    <form id="formularioRegistro" action="">
                                        <span className="pitchComerciantes"><h2> COMUNIDAD <br/>
                                        ...
                                        <input type="password" id="" name="" required/><br/>
                                        <input type="checkbox" name="" id="" style={checkStyle} required/> NO SOY UN ROBOT <br/>                                
                    ...
                    <div className="comunidadComerciantesBeneficios">
                        <div className="colLeft">
                            <div className="containerGreen">
                                <span className="pitchComerciantes subrayar"><h2>Para tu negocio</h2></span>
                                <p>
                                ...
                                <span className="pitchComerciantes subrayar"><h2>Para ti</h2></span>
                                <p>
                                ...
                                <span className="pitchComerciantes subrayar"><h2>Invita A Un Amigo</h2></span>
                                <p>
                    ...
                    <div className="comunidadComerciantesBeneficios2">
                        <span className="pitchComerciantes" ><h1>El plan de beneficios con la membresía incluye</h1></span>
                        <p>
                        ...
                        <span className="pitchComerciantes" ><h1>¿Cuáles son las grandes ventajas de hacer publicidad en Internet?</h1></span>
                        <ul>
                            <span className="pitchComerciantes" ><h2>Alcance y visibilidad. <br/></h2></span>
                            ...
                            <br/>
                            <span className="pitchComerciantes" ><h2>Audiencia calificada y segmentada.<br/></h2></span>
                            <li> 
                            ...
                            <br/>
                            <span className="pitchComerciantes" ><h2>Mejora la penetración de tu marca. <br/></h2></span>
                            <li>
                            ...
                            <br/>
                            <span className="pitchComerciantes" ><h2>Mide el rendimiento de tus anuncios.<br/></h2></span>
                            <li> 
