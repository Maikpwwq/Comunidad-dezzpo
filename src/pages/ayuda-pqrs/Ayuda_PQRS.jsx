                    ...
                    <div className="ayudaPqrsPreguntas">
                        <div className="row">
                            <div className="col">
                                ...
                                <span className="tituloSinMargen">
                                    <h3>
                                        Y aquí, más todas las preguntas
                                        frecuentes
                                    </h3>
                                </span>
                                <ul>
                                    ...
                                    <li>
                                        <a href="#">
                                            ¿Cómo trabajan las calificaciones de
                                            los perfiles?
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#">
                                            Reglamentación del Sistema de Salud
                            ...
                            <div className="col2">
                                ...
                                <p>
                                    Si no estas seguro como la comunidad
                                    funciona,
                                    <br />
                                    o tienes una pregunta que no halla sido
                                    resuelta
                                    <br />
                                    ...
                                    <br />
                                    respondiendo a tus mensajes de lunes a
                                    viernes
                                    <br />
                                </p>
                                <span>
