                ...
                <div className="container">
                    <div className="comunidadPropietariosTitulo">
                        <div className="opacidadNegro">
                            <span className="pitchPropietarios"> <h2>
                            ...
                            <div className="colLeft">
                                <div className="registrateformulario">
                                    <form id="formularioRegistro" action="">
                                        <span className="pitchPropietarios"><h2> COMUNIDAD <br/>
                    ...
                    <div className="comunidadPropietariosConsultar row">
                        <div className="col">
                            ...
                            <span className="pitchPropietarios"><h2>Propietario revisa la</h2></span>
                            <button className="btn" onclick="listaChequeo">lista de chequeo</button>
                            <span>
                                3196138057<br/>
                        ...
                        <div className="col">
                            <span className="pitchPropietarios"><h2>Planea con nosotros el proyecto</h2></span>
                            <p>
                                El espacio de tus sueños comienza con una <br/>
                                gran idea y tenemos miles de ellas.
                            </p>
                            <span className="pitchPropietarios"><h2>Observa cambios</h2></span>
                            <p>
                                Inspirate, tenemos muchos trabajos realizados.
                            </p>
                            <span className="pitchPropietarios"><h2>¿Requieres de asesoria?</h2></span>
                            <p>
                                Nuestra comunidad de comerciantes <br/>
                                calificados te ayudaran con tus inquietudes.
                            </p>
                            <span className="pitchPropietarios"><h2>Presupuestos</h2></span>
                            <p>
                    ...
                    <div className="comunidadPropietariosListaVerificacion">
                        <div className="verificarLista" id="listaChequeo">
                            <span className="pitchPropietarios"><h1>LISTA DE VERIFICACION</h1></span>                    
                            <ul>
                                ...
                                <span className="blueAlert"> Se resuelve la encuesta de satisfacción del servicio</span>
                            </ul>            
                        </div>                
                    </div>
                </div>
